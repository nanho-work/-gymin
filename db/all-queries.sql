...
ALTER TABLE trainer_profiles
  DROP CONSTRAINT IF EXISTS trainer_profiles_birth_year_check;
...
ALTER TABLE trainer_profiles
  DROP CONSTRAINT IF EXISTS trainer_profiles_phone_digits_check;
...
-- 0003_add_media_file_variants.sql
