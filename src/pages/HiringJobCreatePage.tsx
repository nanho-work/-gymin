  ...
  return (
    <Container className="grid gap-6 py-8 lg:grid-cols-[minmax(0,1fr)_360px]">
      ...
      <div className="space-y-5">
        ...
        <aside className="rounded-lg border border-line bg-paper p-5 text-sm leading-6 text-muted">
...
function MockSelect({ label, options }: { label: string; options: string[] }) {
  return (
    <label className="block">
      ...
      <select className="mt-2 h-11 w-full rounded-md border border-line bg-white px-3 text-sm outline-none transition focus:border-green">
        {options.map((option) => (
