          ...
          <section className="rounded-lg border border-line bg-white p-5 shadow-sm">
            ...
            <ul className="mt-4 space-y-3">
              {trainer.workHistory.map((history) => (
                <li className="rounded-md border border-line bg-paper p-4 text-sm font-bold text-muted" key={`${history.gymName}-${history.period}`}>
                  <span className="block font-black text-ink">{history.gymName}</span>
                  <span className="mt-2 block">{history.period}</span>
                  <span className="mt-2 block leading-6">{history.role}</span>
                </li>
              ))}
            </ul>
          </section>
