  ...
  return (
    <section className="border-t border-line pt-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <span className="text-sm font-black text-muted">필수 아님</span>
      </div>
      ...
      <button className="mt-5 w-full border border-dashed border-green bg-white px-4 py-4 text-sm font-black text-forest">
        인증 자료 선택 업로드 UI
      </button>
    </section>
  );
